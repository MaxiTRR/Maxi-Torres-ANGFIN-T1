...
export class RegistroComponent implements OnInit {
  ...
  showTerms() {
    ...
    this.dialog.open(DialogGenericoComponent,{data:{
      data: `<p>
  ...
  <h2>LICENCIA</h2>
    <p>
        AlkyBank  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
    </p>
    ...
    <h2>PRIVACIDAD</h2>
    <p>
        Este http://www.alkybank.com garantiza que la real madrid cf noticias información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
    </p>
    <p>
        La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.
    </p>
    <p>
        AlkyBank reserva los derechos de cambiar o de modificar estos términos sin previo aviso. 
    </p>`,
      title:`<strong>Terminos y Condicones</strong>`
    }})
  }
}
